    ...
    <div className="bg-gray-50 min-h-screen w-full">
      ...
      <section className="bg-blue-800 text-white py-10 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mb-4">
            Detailed description of the service group, its purpose, and how it
            benefits users.
          </p>
        </div>
      </section>
      ...
      <section className="py-10 px-4 max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Here you can provide a detailed explanation of the service,
            eligibility, required documents, and process steps.
          </p>
