...
const meta: Meta = {
  title: 'Henaket/Patterns/ExampleNewsListPage',
  parameters: {
    layout: 'fullscreen',
  },
};
    ...
    <div className="bg-gray-50 min-h-screen w-full">
      ...
      <section className="bg-blue-800 text-white py-10 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mb-4">Stay up to date with the latest news and announcements from the ministry.</p>
        </div>
      </section>
      {/* News List Section */}
      <section className="py-10 px-4 max-w-6xl mx-auto">
        ...
        <div className="mt-8 text-center">
          <button className="border border-blue-800 text-blue-800 px-4 py-2 rounded">Load more news</button>
        </div>
      </section>
      <Footer />
    </div>
