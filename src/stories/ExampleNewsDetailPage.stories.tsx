...
const meta: Meta = {
  title: 'Dzevanmush/NewsDetailPage',
  parameters: {
    layout: 'fullscreen',
  },
};
      ...
      <section className="py-10 px-4 max-w-3xl mx-auto">
        <article className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            This is the main content of the news article. It can include
            multiple paragraphs, images, and other media as needed to convey the
            story in detail.
          </p>
          <p className="text-gray-700 mb-4">
            Additional details, quotes, and context can be added here to provide
            a comprehensive view of the news event.
          </p>
        </article>
