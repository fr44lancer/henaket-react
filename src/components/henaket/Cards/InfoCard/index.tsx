...
export const InfoCard: React.FC<InfoCardProps> = ({
  ...
  return (
    <div
      className={twMerge(
        'rounded-sm border border-gray-200 bg-white shadow-sm  flex flex-col min-w-[220px] max-w-[260px]',
        className,
      )}
    >
      {label && (
      ...
      {image && variant === 'withImage' && (
        <img
          src={image}
          alt="card"
          className="w-full h-28 object-cover rounded-t-sm mb-2"
        />
      )}
      ...
      {icon && variant === 'withIcon' && (
        <div className="w-full flex justify-center items-center bg-blue-700 rounded-b-sm py-12 mt-2">
